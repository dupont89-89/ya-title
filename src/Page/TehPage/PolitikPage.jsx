        ...
        <div>
          <div>
            ...
            <div>
              ...
              предпринимаемые&nbsp;самозанятым Бабий Ксения Юрьевна
            ...
            <div>
              ...
              <div>
                ...
                о&nbsp;посетителях веб-сайта&nbsp;https://tools.ptahini.ru.
              </div>
            </div>
          </div>
        </div>
          ...
          <div>
            ...
            <div>
              <div>
                ...
                данных&nbsp;&mdash; обработка персональных данных с&nbsp;помощью
              ...
              <div>
                ...
                веб-сайта&nbsp;https://tools.ptahini.ru.
              </div>
              <div>
              ...
              <div>
                2.14. Уничтожение персональных данных&nbsp;&mdash; любые
        ...
        <div>
          <div>
            ...
            <div>
              ...
              <div>
                &mdash;&nbsp;самостоятельно определять состав и&nbsp;перечень
              ...
              <div>
                &mdash;&nbsp;прекратить передачу (распространение,
                предоставление, доступ) персональных данных, прекратить
                обработку и&nbsp;уничтожить персональные данные в&nbsp;порядке
        ...
        <div>
          <div>
            ...
            <div>
              ...
              <div>
                &mdash;&nbsp;на&nbsp;отзыв согласия на&nbsp;обработку
                персональных данных, а&nbsp;также, на&nbsp;направление
                требования о&nbsp;прекращении обработки персональных данных;
              </div>
              <div>
                &mdash;&nbsp;обжаловать в&nbsp;уполномоченный орган
          ...
          <div>
            ...
            <div>
              ...
              <div>
                ...
                Оператора&nbsp;info@privateseo.ru&nbsp;с&nbsp;пометкой
              ...
              <div>
                ...
                адрес Оператора&nbsp;app@ptahini.ru&nbsp;с&nbsp;пометкой
          ...
          <div>
            ...
            <div>
              <div>
                ...
                электронной почты&nbsp;app@ptahini.ru.
              </div>
              <div>
              ...
              <div>
                ...
                по&nbsp;адресу&nbsp;https://tools.ptahini.ru.
              </div>
            </div>
          </div>
        </div>
